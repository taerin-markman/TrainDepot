...
trainCounter.name = "train-counter"
trainCounter.icon = "__TrainDepot__/graphics/icons/train-counter.png"
trainCounter.place_result = "train-counter"
trainCounter.order = "a[train-system]-c[ztrain-counter]"
trainCounter.subgroup = "transport"

data:extend({trainDepot, trainDepotStorage, trainCounter})
